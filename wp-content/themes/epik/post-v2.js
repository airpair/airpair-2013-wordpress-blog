    ...
    banner = {
      ...
      saveInfo: function(info) {
        ...
        return $.post("/api/landing/mailchimp/article", info, function(data) {
          addjs.trackCustomEvent("getOfferFromArticle", {
      ...
      openModal: function(info) {
        ...
        return $("#modal-signup").click(function(e) {
